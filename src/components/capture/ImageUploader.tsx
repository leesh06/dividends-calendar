  ...
  return (
    <Card className="text-center">
      {hasImages ? (
        ...
        <div className="py-10 mx-1 my-1 border-2 border-dashed border-dark-border/60 rounded-2xl">
          <svg className="w-16 h-16 mx-auto text-dark-text-secondary/50 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-[11px] text-dark-text-muted/60 mt-3">
            JPG, PNG 지원
          </p>
        </div>
      )}
